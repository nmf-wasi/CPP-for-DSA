...
int main()
{
    ...
    for (int i = 0; i < input - 1; i++)
    {
        ...
        {
            if (Lia[i].eng_marks < Lia[j].eng_marks)
            {
                swap(Lia[i], Lia[j]);
            }
            else if (Lia[i].eng_marks == Lia[j].eng_marks)
            {
                if (Lia[i].math_marks < Lia[j].math_marks)
                {
                    swap(Lia[i], Lia[j]);
                }
                else if (Lia[i].math_marks == Lia[j].math_marks)
                {
